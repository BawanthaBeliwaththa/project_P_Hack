...
page2 = False
logo_design_1 = ('''
{1}    ________      __        __         ______       ___________     __    __          
   | |      ||   |  |      |  |       / /  \ \      |==========    |  |  / /
   | |      ||   |  |______|  |      / /    \ \     ||             |  | / /          
   | |______||   |  |======|  |     / /======\ \    ||             |  |==       
{0}   | |-------    |  |======|  |    / /========\ \   ||             |  | \ \      
...
logo_design_2 = Fore.GREEN + '''                                             
 ...
 .;'  ,;'             `;,  `;,   {0}PHack
.;'  ,;'  ,;'     `;,  `;,  `;,
::   ::   :   {1}( ){0}   :   ::   ::     {2}World Needs Us{2}{0}                         
':.  ':.  ':. {1}/_\{0} ,:'  ,:'  ,:'          
 ':.  ':.    {1}/___\{0}    ,:'  ,:'     {1}by Mr.WhiteHatBAWA{0}
  ':.       {1}/_____\{0}      ,:'
           {1}/       \\{0}
'''.format(Fore.GREEN, Fore.WHITE, Fore.RED)

logo_design_3 = ('''
  {0}     ____  __      _ _ _ _       _ _ _ _  __   __
      / __ \/ /_    / _____ /     / _ _ _/ |  | / /
     / /_/ / __ \  / /     /     / /       |  |/ /
{1}    / ____/ /  / // /_____/__   / /_ _ _   |  |\ \ 
...
\033[92m.mMMm`MMMMMMMMMMMMMMMMMMMM`mMMm.            \033[0m{0} MrWhiteHatBAWA{0}\033[92m
\033[92m:MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM:
:MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM:                    Respect Others !!!
:MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM:                        
:MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM:                    Keep Their Privacy $!!!
-MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM-
...
logo_design_5 = '''
  {0}______   {1}__  __     ______   {0} ___ ____  {1} ___     __
 {0}/\  == \ {1}/\ \_\ \   /\  __ \   {0}\  \ ___\  {1}\  \   / /
 {0}\ \  _-/ {1}\ \  __ \  \ \ \/\ \__ {0}\  \      {1} \  \ / /
  {0}\ \_\    {1}\ \_\ \_\  \ \_____\ \ {0}\  \ ___  {1} \  \ \-\ 
   {0}\/_/     {1}\/_/\/_/   \/_____/\_\ {0}\__\ ___\  {1}\__\ \_-\ 
   {0}         {1}                        {0}           {1}
...
logo_design_8 = '''
        ...
        TTTTTTTTTTTT H      H  EEEEEEEEE     PPPPPPPPPP  H      H       A      CCCCCCCC   K     K   
             T       H      H  E             P        P  H      H      A A     C          K   K             
             T       HHHHHHHH  EEEEEEEEE     PPPPPPPPPP  HHHHHHHH     A   A    C          K  k
             T       H      H  E             P           H      H    AAAAAAA   C          K  K    
             T       H      H  EEEEEEEEE     P           H      H   A       A  CCCCCCCC   K    K
             T                               P                     A         A            K     k
...
{0}[{1}18{0}]{2} Show Mac/Inet                  {0}[{1}23{0}]{2} Remove Password {1}(This is untested "you need to be root")
{0}[{1}19{0}]{2} Extract apk from app           {0}[{1}24{0}]{2} Use Keycode            
{0}[{1}20{0}]{2} Get Battery Status             {0}[{1}25{0}]{2} Get Current Activity                  


{0}[{1}99{0}] {2}Exit   {0}[{1}0{0}] {2}Clear   {0}[{1}b{0}] Back page
'''.format(Fore.CYAN, Fore.RED, Fore.GREEN)
...
def main():
    page_num = 1
    option = input(Fore.WHITE + "PHack"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
    if option == '1':
        ...
        ip = input(arrow+" phack"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
        os.system("adb connect "+ip+":5555")
    
    elif option  == '4':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(shell_on_phone) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell")

    elif option == '5':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter the apk location.").format(Fore.RED, Fore.WHITE))
        apk_location = input("    "+arrow + "PHack"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        os.system("adb -s  "+device_name+" install "+apk_location)
        print (Fore.GREEN  +  "Apk has been installed.")

    elif option ==  '6':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        place_location = input("    "+arrow + "PHack"+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull /sdcard/demo.mp4 "+place_location)

    elif option  == '7':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        place_location = input("    "+arrow + "PHack"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a file location on a device").format(Fore.RED, Fore.WHITE))
        file_location = input("    "+arrow + "PHack"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("        "+connect))
        print (("       [{0}+{1}]Enter where you would like the file to be saved.").format(Fore.RED, Fore.WHITE))
        place_location = input("       "+arrow + "PHack"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull "+file_location+" "+place_location)

    elif option == '10':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(device_reboot) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+ " reboot ")
    
    elif option ==  '11':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name.").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "PHack"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" unistall "+package_name)

    elif option == '12':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(log) "+Fore.WHITE + "> ")
        os.system('adb -s '+device_name+" logcat ")

    elif option == '13':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(sys_info) "+Fore.WHITE + "> ")
        os.system("adb shell "+device_name+" dumpsys")        

    elif option == '14':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(package_manager) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell pm list packages -f")
        main()

    elif option == '15':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "PHack"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell monkey -p "+package_name+" -v 500")
        main()      

    elif option == '16':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a port on the device.").format(Fore.RED, Fore.WHITE))
        port_device = input("    "+arrow + "PHack"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("         "+connect))
        print (("        [{0}+{1}]Enter a port to forward it too.").format(Fore.RED, Fore.WHITE))
        forward_port = input("        "+arrow + "PHack"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        ...
        try:
            ...
            device_name = input(arrow + "PHack"+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")
            ...
            location = input("    "+arrow + "PHack"+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")      
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(mac_inet) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell ip address show wlan0")
        main()

    elif option == '19':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "PHack"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        ...
        path = input("        "+arrow + "PHack"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("             "+connect))
        print (("            [{0}+{1}]Enter The location to store the apk: ")  .format(Fore.RED, Fore.WHITE))
        location =   input("            "+arrow + "PHack"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+" pull "+path+" "+location)
        main()

    elif option == '20':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(battery) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell dumpsys battery")
        main()

    elif option == '21':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(net_stat) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell netstat")
        main()

    elif option == '22':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(wifi) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(pass_remove) "+Fore.WHITE + "> ")
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        print ('''
0 -->  "KEYCODE_UNKNOWN" 
1 -->  "KEYCODE_MENU" 
...
85 -->  "TAG_LAST_KEYCODE"        
        ...
        num = input(arrow + "PHack"+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell input keyevent "+num)

    elif option == '25':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "PHack"+Fore.RED + "(current_activity) "+Fore.WHITE + "> ")
...
def main_linux():
    ...
    page_num = 1
    os.system("adb tcpip 218")
    os.system("adb devices -l")
    print (("\n[{0}+{1}] Enter a phones ip address.(Type 99 to exit)").format(Fore.RED, Fore.WHITE))
    try:
        device_name = input (arrow+" PHack"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
    except KeyboardInterrupt:
        main()
    if device_name == '':
        main()
    if device_name == '99':
        exit()
    os.system("adb connect "+device_name+":218")
    option = input(Fore.WHITE + "PHack"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
